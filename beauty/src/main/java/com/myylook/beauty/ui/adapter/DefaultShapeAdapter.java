...
import com.myylook.beauty.ui.bean.ShapeBean;
    ...
    class Vh extends RecyclerView.ViewHolder {
        ...
        void setData(ShapeBean bean, int position, Object payload) {
            ...
            if (bean.isChecked()) {
                ...
                mShapeName.setTextColor(CommonAppContext.sInstance.getResources().getColor(R.color.shape_icon_select_color));
            } else {
                mImg.setImageResource(bean.getImgSrc());
                mShapeName.setTextColor(CommonAppContext.sInstance.getResources().getColor(R.color.bg_black));
            }
        }
    }
