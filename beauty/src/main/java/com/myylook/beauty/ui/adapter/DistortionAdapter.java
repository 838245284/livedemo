...
import com.myylook.beauty.ui.bean.SpeciallyBean;
...
public class DistortionAdapter extends RecyclerView.Adapter<DistortionAdapter.Vh> {
    ...
    public DistortionAdapter(Context context) {
        mList = new ArrayList<>();
        stringArray = CommonAppContext.sInstance.getResources().getStringArray(R.array.distortion_name_list);
    ...
    class Vh extends RecyclerView.ViewHolder {
        ...
        void setData(SpeciallyBean bean, int position, Object payload) {
            ...
            if (bean.ismChecked()) {
                ...
                mDistortionName.setTextColor(CommonAppContext.sInstance.getResources().getColor(R.color.shape_icon_select_color));
            } else {
                if (mCheckImg.getVisibility() == View.VISIBLE) {
                    mCheckImg.setVisibility(View.INVISIBLE);
                }
                mDistortionName.setTextColor(CommonAppContext.sInstance.getResources().getColor(R.color.bg_black));
            }
        }
    }
}
