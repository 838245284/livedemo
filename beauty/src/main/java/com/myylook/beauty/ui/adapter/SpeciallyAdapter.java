package com.myylook.beauty.ui.adapter;
...
public class SpeciallyAdapter extends BaseBeautyAdapter<SpeciallyAdapter.ViewHolder, BeautyBean> {
    ...
    SpeciallyAdapter(Context context) {
        super(context, 1);
        mList = new ArrayList<>();
        stringArray = CommonAppContext.sInstance.getResources().getStringArray(R.array.specially_name_list);
        ...
        for (int i = 0; i < stringArray.length; i++) {
            ...
            int imgSrc = speciallyArray.getResourceId(i, com.myylook.beauty.R.mipmap.beauty_origin);
            int ImgSrcSel = speciallyArray.getResourceId(i, com.myylook.beauty.R.mipmap.beauty_origin);
...
//        TextView mSpeciallyName;
        ...
        void setData(BeautyBean bean, int position, Object payload) {
            ...
            if (bean.isChecked()) {
                ...
                mBeautyName.setTextColor(CommonAppContext.sInstance.getResources().getColor(R.color.shape_icon_select_color));
            } else {
                if (mCheckImg.getVisibility() == View.VISIBLE) {
                    mCheckImg.setVisibility(View.INVISIBLE);
                }
                mBeautyName.setTextColor(CommonAppContext.sInstance.getResources().getColor(R.color.bg_black));
            }
        }
    }
}
