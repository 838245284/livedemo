package com.myylook.beauty.ui.manager;
...
import com.myylook.beauty.ui.adapter.StickerAdapter;
import com.myylook.beauty.ui.bean.StickerBeautyBean;
import com.myylook.beauty.ui.bean.StickerCategaryBean;
import com.myylook.beauty.ui.bean.StickerServiceBean;
...
public class StickerManager {
    ...
    private StickerManager() {
        synchronized (StickerManager.class) {
            if (!flag) {
                mCurStickerName = CommonAppContext.sInstance.getResources().getString(R.string.filter_no);
                flag = true;
            } else {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        if (beanObject.has("name")) {
                            ...
                            if (name.equals("推荐")) {
                                name = CommonAppContext.sInstance.getResources().getString(com.meihu.beautylibrary.R.string.sticker_clasic);
                            } else if (name.equals("高级")) {
                                name = CommonAppContext.sInstance.getResources().getString(com.meihu.beautylibrary.R.string.sticker_update);
                            } else if (name.equals("简约")) {
                                name = CommonAppContext.sInstance.getResources().getString(com.meihu.beautylibrary.R.string.sticker_dim);
                            } else if (name.equals("萌物")) {
                                name = CommonAppContext.sInstance.getResources().getString(com.meihu.beautylibrary.R.string.sticker_sticker);
                            } else if (name.equals("少女")) {
                                name = CommonAppContext.sInstance.getResources().getString(com.meihu.beautylibrary.R.string.sticker_shyly);
                            }
                        }
...
//                                    }
                            ...
                            if (TextUtils.isEmpty(name)) {
                                ...
                                stickerServiceBean.setName(CommonAppContext.sInstance.getResources().getString(R.string.filter_no));
                            }
                            stickerServiceBean.setStickerBeautyData(stickerBeautyBean);
                            boolean fileExist = isStickerFileExist(CommonAppContext.sInstance, name);
