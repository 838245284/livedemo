...
import com.myylook.beauty.ui.adapter.BeautyPagerAdapter;
import com.myylook.beauty.ui.adapter.DistortionAdapter;
import com.myylook.beauty.ui.adapter.SpeciallyPagerAdapter;
import com.myylook.beauty.ui.adapter.StickerPagerAdapter;
import com.myylook.beauty.ui.bean.BeautyBean;
...
import com.myylook.beauty.ui.interfaces.MHBeautyEffectListener;
import com.myylook.beauty.ui.interfaces.MHCameraClickListener;
import com.myylook.beauty.ui.interfaces.OnItemClickListener;
import com.myylook.beauty.ui.views.custom.ScaleImageButton;
import com.myylook.beauty.ui.views.custom.TextSeekBarNew;
...
public abstract class BaseBeautyViewHolder extends AbsViewHolder implements MHBeautyEffectListener, IBeautyViewHolder, View.OnClickListener, TextSeekBarNew.OnSeekChangeListener, OnItemClickListener<BeautyBean> {
    ...
    private View mBeautyControlRoot;
    ...
    public void init() {
        ...
        mBeautyControlRoot = findViewById(R.id.rl_beauty_control_root);
        ...
        switch (type) {
            case FILTER_TYPE_ENUM:
                ...
                if (bean instanceof FilterBean) {
                    onFilterChanged(((FilterBean) bean));
                }
                break;
