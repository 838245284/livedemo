...
import com.myylook.beauty.ui.enums.BeautyTypeEnum;
import com.myylook.beauty.ui.enums.FilterEnum;
import com.myylook.beauty.ui.enums.QuickBeautyEnum;
import com.myylook.beauty.ui.enums.QuickBeautyShapeEnum;
...
public class BeautyDataModel implements IBeautyData {
    ...
    private BeautyDataModel() {
        ...
        beautyDefaultDatas = resources.getIntArray(R.array.name_beauty_default_progress);
        beautyAllNames = resources.getStringArray(R.array.name_beauty_name_array);
        beautyBasicNames = resources.getStringArray(R.array.name_basic_beauty_name_array);
        beautyOriginDatas = resources.getIntArray(R.array.name_beauty_origin_progress);
...
//    }
    ...
    public void setWatermark(int i) {
        String[] stringArray = CommonAppContext.sInstance.getResources().getStringArray(R.array.specially__watermark_name_list);
        TypedArray speciallyArray = CommonAppContext.sInstance.getResources().obtainTypedArray(R.array.specially_watermark_icon_list);
        TypedArray speciallyArraySel = CommonAppContext.sInstance.getResources().obtainTypedArray(R.array.specially_watermark_sel_list);
...
//    }
    ...
    public synchronized void setBeautyDataMap(int[] progressList) {
        ...
        String[] stringArray = CommonAppContext.sInstance.getResources().getStringArray(R.array.name_beauty_name_array);
