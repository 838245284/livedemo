...
public class CommonAppConfig {
    ...
    public static boolean isYunBaoApp() {
        ...
        if (!TextUtils.isEmpty(packageName)) {
            return packageName.contains("com.yunbao.phone");
        }
        return false;
    }
    ...
    public String getAppName() {
        if (TextUtils.isEmpty(mAppName)) {
            int res = CommonAppContext.sInstance.getResources().getIdentifier("app_name", "string", "com.yunbao.phonelive");
    ...
    public int getAppIconRes() {
        if (mAppIconRes == 0) {
            mAppIconRes = CommonAppContext.sInstance.getResources().getIdentifier("ic_launcher", "mipmap", "com.yunbao.phonelive");
        }
        return mAppIconRes;
    }
