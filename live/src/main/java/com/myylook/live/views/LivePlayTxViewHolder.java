...
//
//                View txVideoView = mVideoView.getVideoView();
//                float vw = txVideoView.getWidth();
//                float vh = txVideoView.getHeight();
//                L.e(TAG, "txVideoView---width----->" + vw);
//                L.e(TAG, "txVideoView---height----->" + vh);
//
//                if (width >= height) {//横屏 9:16=0.5625
//                    if (vw > screenW) {
//                        float scale = screenW / vw;
//                        txVideoView.setScaleX(scale);
//                        txVideoView.setScaleY(scale);
//                    }else{
//                        txVideoView.setScaleX(1);
...
//                        float screenRatio = screenH / screenW;
//                        float streamRatio = height / width;
//                        if (streamRatio < screenRatio) {//会留黑边
//                            L.e(TAG, "-----会留黑边--->");
//                            float scale=screenRatio/streamRatio;
//                            txVideoView.setScaleX(scale);
//                            txVideoView.setScaleY(scale);
