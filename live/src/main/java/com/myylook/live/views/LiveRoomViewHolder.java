...
import com.myylook.live.activity.LiveAnchorActivity;
import com.myylook.live.activity.LiveAudienceActivity;
import com.myylook.live.adapter.LiveChatAdapter;
import com.myylook.live.adapter.LiveUserAdapter;
...
import com.myylook.live.custom.LiveLightView;
import com.myylook.live.custom.TopGradual;
import com.myylook.live.dialog.LiveUserDialogFragment;
import com.myylook.live.http.LiveHttpConsts;
import com.myylook.live.http.LiveHttpUtil;
import com.myylook.live.presenter.LiveDanmuPresenter;
import com.myylook.live.presenter.LiveEnterRoomAnimPresenter;
import com.myylook.live.presenter.LiveGiftAnimPresenter;
import com.myylook.live.presenter.LiveLightAnimPresenter;
...
public class LiveRoomViewHolder extends AbsViewHolder implements View.OnClickListener {
    ...
    public void setTitle(String title) {
        if (!TextUtils.isEmpty(title)) {
            if (mLiveGiftAnimPresenter == null) {
                mLiveGiftAnimPresenter = new LiveGiftAnimPresenter(mContext, mContentView, mGifImageView, mSVGAImageView, mLiveGiftPrizePoolContainer, mPrizePoolLevel, mPrizePoolGuang);
            }
    ...
    private void forwardGoods() {
        ...
        if (mShowGoodsBean != null) {
            if (mShowGoodsBean.getType() == 1) {
                RouteUtil.forwardGoodsDetailOutSide(mShowGoodsBean.getId(), false);
            } else {
                RouteUtil.forwardGoodsDetail(mShowGoodsBean.getId(), false,mLiveUid);
            }
        }
    }
