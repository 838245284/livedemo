...
import com.myylook.main.views.GoodsAddTaoBaoViewHolder;
import com.myylook.main.views.GoodsAddXcxViewHolder;
...
import static com.myylook.main.http.MainHttpConsts.SET_GOODS;
...
public class GoodsAddActivity extends AbsActivity {
    ...
    protected void main() {
        if (mIsOpenApplets) {
            PAGE_COUNT = 2;
            mTitles = new String[]{WordUtil.getString(R.string.mall_375), WordUtil.getString(R.string.goods_add_xcx)};
        } else {
            PAGE_COUNT = 1;
            mTitles = new String[]{WordUtil.getString(R.string.mall_375)};
        }
