...
import com.myylook.mall.bean.SearchGoodsBean;
import com.myylook.mall.bean.SearchPayBean;
import com.myylook.mall.http.MallHttpConsts;
import com.myylook.mall.http.MallHttpUtil;
import com.myylook.mall.views.SearchGoodsViewHolder;
import com.myylook.mall.views.SearchPayViewHolder;
import com.myylook.mall.views.SearchPlatGoodsViewHolder;
...
public class GoodsSearchActivity extends AbsActivity {
    ...
    protected void main() {
        ...
        final String[] titles = new String[]{WordUtil.getString(R.string.mall_354), WordUtil.getString(R.string.mall_406), WordUtil.getString(R.string.mall_355)};
