...
import com.myylook.mall.custom.ShopIndicatorTitle;
import com.myylook.mall.views.ShopHomeMyViewHolder;
import com.myylook.mall.views.ShopHomePlatViewHolder;
...
public class ShopHomeActivity extends AbsActivity implements View.OnClickListener {
    ...
    protected void main() {
        ...
        mSmartRefreshLayout = (SmartRefreshLayout) findViewById(com.myylook.common.R.id.refreshLayout);
        ...
        int textColor = ContextCompat.getColor(mContext, com.myylook.common.R.color.textColor);
        mHeader = findViewById(com.myylook.common.R.id.header);
